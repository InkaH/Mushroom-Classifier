...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private boolean isPoisonous(Recognition rec) {
    if(rec.getTitle() != null && rec.getTitle().contains("*")){
      rec.setTitle(rec.getTitle().replace("*", ""));
      return true;
    }
    return false;
  }

  private void setTextColorAndEditTitle(Recognition rec, TextView view) {
    if(rec.getTitle().contains("--")){
      view.setTextColor(Color.RED);
    }
    else if(rec.getTitle().contains("++")){
      //dark green
      view.setTextColor(Color.parseColor("#368213"));
    }
    else {
    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        if (recognition.getTitle() != null){
          setTextColorAndEditTitle(recognition, recognitionTextView);
      ...
      if (recognition1 != null) {
        if (recognition1.getTitle() != null){
          setTextColorAndEditTitle(recognition1, recognition1TextView);
      ...
      if (recognition2 != null) {
        if (recognition2.getTitle() != null){
          setTextColorAndEditTitle(recognition2, recognition2TextView);
      ...
      if (recognition3 != null) {
        if (recognition3.getTitle() != null){
          setTextColorAndEditTitle(recognition3, recognition3TextView);
      ...
      if (recognition4 != null) {
        if (recognition4.getTitle() != null){
          setTextColorAndEditTitle(recognition4, recognition4TextView);
